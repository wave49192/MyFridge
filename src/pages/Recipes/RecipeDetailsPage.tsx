...
const RecipeDetailsPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center bg-white text-accent shadow-lg">
      ...
      <p className="text-md mb-2">
        Cooking Time:{" "}
        <span className="text-md text-primary">{recipe.cooking_time} mins</span>
      </p>
      <div className="card w-96 bg-base-100 shadow-xl bg-primary-2 bg-opacity-25">
        ...
        <nav>
          ...
          <div className="grid grid-flow-col gap-4">
            ...
            <a>
              ...
              >
                <path
                  d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.
266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z"
                ></path>
              </svg>
            </a>
            <a>
